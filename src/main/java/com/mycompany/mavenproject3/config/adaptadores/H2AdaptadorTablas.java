...
public class H2AdaptadorTablas implements AdaptadorTablas{
    ...
    public String crearTablaDepartamento() {
        return "CREATE TABLE IF NOT EXISTS DEPARTAMENTO (" +
                ...
                "nombre VARCHAR(50), " +
                "paisId INT, " +
                "FOREIGN KEY (paisId) REFERENCES PAIS(paisId) ON DELETE CASCADE);";
    }
    ...
    public String crearTablaMunicipio() {
        return "CREATE TABLE IF NOT EXISTS MUNICIPIO (" +
                ...
                "nombre VARCHAR(50), " +
                "departamentoId INT, " +
                "FOREIGN KEY (departamentoId) REFERENCES DEPARTAMENTO(departamentoId) ON DELETE CASCADE);";
    }
    ...
    public String crearTablaPersona(){
        return "CREATE TABLE IF NOT EXISTS PERSONA(" +
                ...
                "municipioId INT, " +
                "FOREIGN KEY (municipioId) REFERENCES MUNICIPIO(municipioId) ON DELETE CASCADE);";
    }
