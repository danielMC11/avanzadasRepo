package com.mycompany.mavenproject3.dao.baseDeDatos.departamento;

import com.mycompany.mavenproject3.base.Departamento;
import com.mycompany.mavenproject3.config.H2Server;
import com.mycompany.mavenproject3.dao.baseDeDatos.pais.PaisDAO;
...
public class DepartamentoDAOImpl implements DepartamentoDAO {
	...
	public DepartamentoDAOImpl(H2Server db){
		this.db = db;
		paisDAO = new PaisDAOImpl(db);
	}


	@Override
	public void guardar(Departamento d){
