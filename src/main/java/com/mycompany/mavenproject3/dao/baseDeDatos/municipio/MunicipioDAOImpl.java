package com.mycompany.mavenproject3.dao.baseDeDatos.municipio;

import com.mycompany.mavenproject3.base.Municipio;
import com.mycompany.mavenproject3.config.H2Server;
import com.mycompany.mavenproject3.dao.baseDeDatos.departamento.DepartamentoDAO;
...
public class MunicipioDAOImpl implements MunicipioDAO{
	...
	public MunicipioDAOImpl(H2Server db) {
		this.db = db;
